...
/**
 * \file    test/phpunit/ProposalWithDaysFunctionalTest.php
...
/**
 * Class ProposalWithDaysFunctionalTest
 *
 ...
 *
 * @package Testproposalwithdays
 */
class ProposalWithDaysFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 580008; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modProposalWithDays')->click();
		} else {
			// Disable the module
			$this->byHref('modProposalWithDays')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/proposalwithdays/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('proposalwithdays/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/proposalwithdays/admin/about.php');
		$this->authenticate();
		return $this->assertContains('proposalwithdays/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('proposalwithdayswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modProposalWithDays_ProposalWithDaysTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProposalWithDays_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
